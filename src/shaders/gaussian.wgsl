...
struct VertexInput {
    ...
    @location(2) cov1: vec3<f32>,
    @location(3) cov2: vec3<f32>,
...
fn vs_main(
    ...
    let focal = vec2<f32>(600.,600.);
    let viewport = vec2<f32>(800.,600.);
    ...
    // let offset = position*0.01;//*vec2<f32>(lambda1,lambda2);
